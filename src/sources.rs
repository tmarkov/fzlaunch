...
use crate::config::{CalculatorSourceConfig, FilesystemSourceConfig, PathSourceConfig};
...
mod tests {
    ...
    use crate::{
        config::CalculatorSourceConfig, config::FilesystemSourceConfig, config::PathSourceConfig,
    };
    use tokio::task::JoinHandle;
    ...
    fn calculator() -> super::Calculator {
        super::Calculator::new(CalculatorSourceConfig::default())
    }
